        ...
        "\n".join(
            [
                ...
                *[
                ...
                "9. 国10图片已人工复核：大市场/小市场要分叉推演，大市场可用 6 柔 P2 拉短贷抢节奏，小市场优先 8 柔 P1 降低第一年风险；M1/M3 广告、清产能、转产和提前研发都必须受现金流约束。",
                "",
                "## 算法化推演模型 v2",
                "",
                ...
                "## 图片人工复核内容",
                "",
                "来源：`C:/Users/胡宇程/Desktop/逻辑/a06ecc0499d67f731da92f768f11759.jpg`。",
                "",
                "1. 图中“国10”把策略分为大市场与小市场两种情形，说明同一规则不能套一个固定开局，需要先判断市场规模、产线产能差距和第一年现金风险。",
                "2. 大市场思路：6柔P2、拉短贷，P3/P4/M3按时间点提前研发；第一年第二季度根据原材料采购情况和现金流投广告并清空产能；第二年、第三年、第四年广告投放前都要清产能。",
                "3. 小市场思路：8柔P1降低第一年P2拥挤风险，第一年可留部分P1库存到第二年高价卖；第二年不急于加线，留现金投广告并吃补单；现金不足时允许继续生产部分P2。",
                "4. 广告经验值只能作为打法参考，不作为规则硬数值：大市场图中给出Y1约2k-1w、Y2约50w-60w+5w-10w、Y3约150w-250w、Y4约300w-600w；小市场图中给出Y1约1k、Y2约5w和10w附近、Y3约120w-220w、Y4约400w-600w。",
                "5. 图中总结强调：国10生产线产能差距大；市场大时6柔P2开局节奏更快，市场小时第一年P2拥挤，8柔P1风险更低；若3年2月M3订单和现金流允许，可考虑M3提前到第一年研发，以便3年1月M2卖P2、3年2月低广告卖P3。",
            ]
        ),
        encoding="utf-8",
    )
